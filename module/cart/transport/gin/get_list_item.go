...
func GetListItem(appCtx appctx.AppContext) gin.HandlerFunc {
	return func(context *gin.Context) {
		...
		biz := cartbusiness.NewListCartItemBusiness(storage)
		result, err := biz.ListCartItem(context.Request.Context(), userId)
		if err != nil {
			panic(err)
		}
